...
/*
     UDP방식 : 비연결 지향, 신뢰성이 없다, 데이터가 순서대로 도착한다는 보장이 없다. 그렇지만 TCP방식보다 속도가 빠르다.
	...
	public static void main(String[] args) {
		try {
			...
			while(true) {
				...
				//                         수신용 패킷을 생성할 때 지정한 byte형 배열에도 저장된다.
				...
				//         ==> 전송할 데이터의 길이, 상대방의 주소정보, 포트번호 이렇게 4가지를 지정하여 생성한다.
